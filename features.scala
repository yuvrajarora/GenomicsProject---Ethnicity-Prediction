...
object featureExtractor {
  def main(args: Array[String]): Unit = {
    val genotypeFile = "/Users/yuvrajarora/GitHub/CSCI7000Genomics/src/ALL.chrY.phase3_integrated_v2a.20130502.genotypes.vcf"
    val panelFile = "/Users/yuvrajarora/GitHub/CSCI7000Genomics/src/genotypes.panel"
    ...
    val populations = Set("BEB", "PJL", "ESN", "IBS", "PUR")
    ...
    // Load the ADAM genotypes from the file(s)
    ...
    val union = sc.loadGenotypes(genotypeFile,  stringency = ValidationStringency.SILENT)
   ...
   println(variantFrequencies.max)   
    ...
    schemaDF.coalesce(1).write.csv("results/train.csv")
